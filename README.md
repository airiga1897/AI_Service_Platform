...
Политика источников миграции описана в `docs/MIGRATION_SOURCES.md`. SoftEther VPN — обязательный edge/инфра-компонент платформы, не привязанный к продуктам, описан в `docs/SOFTETHER_VPN.md`. Исследования по CDN, GeoIP, GeoDNS и ускорению VPN собраны в `docs/CDN_GEO_POLICY.md`. Целевая VPN-топология: SoftEther на VPS1, VPS2 и VPS6; HAProxy публикует текущие TCP-входы.
