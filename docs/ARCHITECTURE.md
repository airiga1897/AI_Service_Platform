...
Общий сервис GeoPolicy может выступать единым источником IP/policy-решений. Из него могут генерироваться HAProxy policy lists, цели VPN GeoDNS, egress-профили и входы политик CDN. Применение остаётся раздельным по типу трафика, чтобы правило защиты сайтов не сломало случайно VPN-доступ или продуктовое переключение.
